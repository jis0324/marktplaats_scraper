...
class Crawlsystem(object):
  ...
  def main(self):
    ...
    try:
      self.get_category_page('ANTIEK_EN_KUNST', 'https://www.marktplaats.nl/a/antiek-en-kunst/antiek-meubels-kasten/m1565709128-mooie-grenen-hoek-kast.html?c=79ed80c9780cc8e98aac57a99a9de18b&previousPage=l1')
